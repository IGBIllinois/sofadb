...
$(document).ready(function() {
	...
	//$.get("func.php", {
		//'deletedmethods' : deleteRow('hortable')}
		//mtypenum : $('#methodtype').val(),
		//mtype : $('#methodtype option:selected').html(),
		//mname : $('#drop_2 option:selected').html(),
		//featname : $('#drop_3 option:selected').html()
   ...
   if(isset($_POST['race_white']))
    ...
    $numcasemethods=$_SESSION['num_methods'];
		...
		$result=mysqli_query ($dbcon, $q) ; 	
        	...
        	$q = "INSERT INTO cases (id,casename, 	casenumber,memberid,caseagency,fasex,faage,faage2,faageunits,faageunits2,fastature,fastature2,fastatureunits,idsex,idage,idageunits,idstature,idstatureunits,idsource,casenotes,datestarted,datemodified,submissionstatus,faancestryas,faancestryeuro,faancestryaf,faancestryna,faancestryhi,faancestryot,faancestryottext,idraceas,idraceaf,idracewh,idracehi,idracena,idraceot,idraceottext,nummethods) VALUES (' ', '$casenam', '$casenum','$memberid','$caseag','$fasex','$faage','$faage2','$faageunits','$faageunits2','$fastature','$fastature2','$fastatureunits','$idsex','$idage','$idageunits','$idstature','$idstatureunits','$idsource','$casenotes',NOW(),NOW(),'0','$faAs','$faWh','$faBl','$faNa','$faHi','$faOt','$faothertext','$idAs','$idBl','$idWh','$idHi','$idNa','$idOt','$idothertext','$numcasemethods')";	
		...
		$inid=mysql_insert_id();
                ...
                $methodtypesave=$_SESSION['methodtype'][$i-1];
                 ...
                 $q="INSERT INTO tier2data (id,memberid,caseid,methodtype,methodid,featureid) VALUES (' ','$memberid','$caseidx','$methodtypesave','$methodidsave','$methodfeatsave')";
...
?>
  ...
  <div id="caseform">
    <form action="index_dyn.php" method="post" id="casedata">
...
<div id="tabs-1">
  ...
  <select name="fasex">
   ...
   <div id="tabs-2">
    ...
    <p> 
					 <input type="button" id="addmethodbutton" value="Add Method" >
					<input type="button" value="Remove Method" id="removemethodbutton"  /> 
                    	<input type="button" value="Edit Method" onClick="editRow('hortable')"  />
                         
					(Edit/Remove applies to entries with marked check boxes.)
