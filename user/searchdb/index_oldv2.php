...
<br>
<span><label class="label" for="exportall">Click here to export all cases</label><input name="exportall" type="button" id="exportall" title="Export All" value="Export All"></span><br>
