...
CREATE TABLE `cases` (
  ...
  `faancestryeuro` boolean default 0,
  `faancestryaf` boolean default 0,
  `faancestryas` boolean default 0,
  `faancestryna` boolean default 0,
  `faancestryhi` boolean default 0,
  `faancestryot` boolean default 0,
