...
<div id="tabs-1">
  ...
  <label class="label" for="casename">Case Nickname</label><input id="casename" type="text" name="casename" size="30" maxlength="30" value="<?php if (isset($casedata['casename'])) echo $casedata['casename']; ?>"readonly/>
  ...
  <select name="fasex" disabled>
    ...
    <input type="checkbox" name="farace_asian" value="1" <?php if (isset($casedata['faancestryas'])AND $casedata['faancestryas'] == 1) echo ' checked'; ?> disabled/>Asian/Pacific Islander
    <input type="checkbox" name="farace_black" value="1" <?php if (isset($casedata['faancestryaf']) AND $casedata['faancestryaf'] == 1) echo ' checked'; ?> disabled/>Black/African-American
    <input type="checkbox" name="farace_hispanic" value="1" <?php if (isset($casedata['faancestryhi']) AND $casedata['faancestryhi'] == 1) echo ' checked'; ?> disabled/>Hispanic<br />
    <label class="label" for="faancestry2"></label>
    <input type="checkbox" name="farace_native" value="1" <?php if (isset($casedata['faancestryna']) AND $casedata['faancestryna'] == 1) echo ' checked'; ?> disabled/>Native American
    <input type="checkbox" name="farace_white" value="1" <?php if (isset($casedata['faancestryeuro']) AND $casedata['faancestryeuro'] == 1) echo ' checked'; ?> disabled />White
    <input type="checkbox" name="farace_other" value="1" <?php if (isset($casedata['faancestryot']) AND $casedata['faancestryot'] == 1) echo ' checked'; ?> disabled/>Other: &nbsp; <input id="farace_othertext" type="text" name="farace_othertext" size="18" maxlength="30" value="<?php if (isset($casedata['faancestryottext'])) echo $casedata['faancestryottext']; ?>"readonly/>
   ...
   Method Type
				...
				<td>".$_SESSION['methodtablefeature'][$i-1]."|".$_SESSION['methodtablephase'][$i-1]."</td>
				</tr>
				";
